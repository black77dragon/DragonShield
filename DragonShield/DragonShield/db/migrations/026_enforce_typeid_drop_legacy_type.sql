-- migrate:up
-- Purpose: Drop legacy TEXT type columns, enforce NOT NULL type_id with FK
...
INSERT INTO PortfolioThemeUpdate_new
  (id, theme_id, title, body_text, body_markdown, type_id, author, pinned, positions_asof, total_value_chf, created_at, updated_at, soft_delete, deleted_at, deleted_by)
SELECT id, theme_id, title, body_text, body_markdown, type_id, author, pinned, positions_asof, total_value_chf, created_at, updated_at, soft_delete, deleted_at, deleted_by
...
INSERT INTO PortfolioThemeAssetUpdate_new
  (id, theme_id, instrument_id, title, body_text, body_markdown, type_id, author, pinned, positions_asof, value_chf, actual_percent, created_at, updated_at)
SELECT id, theme_id, instrument_id, title, body_text, body_markdown, type_id, author, pinned, positions_asof, value_chf, actual_percent, created_at, updated_at
...
-- migrate:down
-- Recreate tables with nullable type_id and legacy type TEXT (best-effort)
...
INSERT INTO PortfolioThemeUpdate_old
  (id, theme_id, title, body_text, body_markdown, type, type_id, author, pinned, positions_asof, total_value_chf, created_at, updated_at, soft_delete, deleted_at, deleted_by)
SELECT id, theme_id, title, body_text, body_markdown, (SELECT code FROM NewsType WHERE id = type_id), type_id, author, pinned, positions_asof, total_value_chf, created_at, updated_at, soft_delete, deleted_at, deleted_by
FROM PortfolioThemeUpdate;
DROP TABLE PortfolioThemeUpdate;
...
INSERT INTO PortfolioThemeAssetUpdate_old
  (id, theme_id, instrument_id, title, body_text, body_markdown, type, type_id, author, pinned, positions_asof, value_chf, actual_percent, created_at, updated_at)
SELECT id, theme_id, instrument_id, title, body_text, body_markdown, (SELECT code FROM NewsType WHERE id = type_id), type_id, author, pinned, positions_asof, value_chf, actual_percent, created_at, updated_at
FROM PortfolioThemeAssetUpdate;
DROP TABLE PortfolioThemeAssetUpdate;
