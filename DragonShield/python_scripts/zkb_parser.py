...
# - 0.17 -> 0.18: Improved interpreter debug notes.
...
from parser_utils import (
    parse_statement_date_from_filename,
    parse_date_from_excel_cell,
    parse_portfolio_nr_from_cell_value,
    parse_number_from_cell_value,
    get_mapped_instrument_group,
    ANLAGEKATEGORIE_TO_GROUP_MAP,
    ASSET_UNTERKATEGORIE_REFINEMENT_MAP,
...
PYTHON_USED = os.environ.get("DS_PYTHON_PATH", sys.executable)
    ...
    try:
        ...
        for row_idx_iter, row_cells_tuple in row_iter:
            ...
            if asset_unterkategorie_str == "Konten":
                ...
                record_data["valor"] = get_str_val_from_tuple(COL_VALOR)
