...
extension DatabaseManager {
    ...
    func upsertClassTarget(
        portfolioId: Int,
        classId: Int,
        percent: Double,
        amountChf: Double? = nil,
        targetKind: String = "percent",
        ...
        if sqlite3_prepare_v2(db, query, -1, &statement, nil) == SQLITE_OK {
            ...
            sqlite3_bind_text(statement, 4, targetKind, -1, SQLITE_TRANSIENT)
    ...
    func upsertSubClassTarget(
        ...
        if sqlite3_prepare_v2(db, query, -1, &statement, nil) == SQLITE_OK {
            ...
            sqlite3_bind_text(statement, 5, targetKind, -1, SQLITE_TRANSIENT)
