...
struct PortfolioView: View {
    ...
    var body: some View {
        ...
        .sheet(item: $notesTarget) { target in
            InstrumentNotesView(instrumentId: target.instrumentId, instrumentCode: target.instrumentCode, instrumentName: target.instrumentName, initialTab: target.initialTab, initialThemeId: target.initialThemeId, onClose: { notesTarget = nil })
