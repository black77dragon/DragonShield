...
struct PortfolioThemeUpdatesView: View {
    ...
    @State private var updatesWithAttachments: Set<Int> = []
                ...
                ForEach(updates) { update in
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        HStack {
                            ...
                            if updatesWithAttachments.contains(update.id) { Image(systemName: "paperclip") }
                        }
    ...
    private func load() {
        ...
        if FeatureFlags.portfolioAttachmentsEnabled() {
            ...
            updatesWithAttachments = Set(updates.compactMap { repo.hasAttachments(updateId: $0.id) ? $0.id : nil })
        } else {
            updatesWithAttachments = []
        }
