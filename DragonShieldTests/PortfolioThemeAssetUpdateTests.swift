...
final class PortfolioThemeAssetUpdateTests: XCTestCase {
    ...
    func testListThemesForInstrumentWithCounts() {
        ...
        sqlite3_exec(manager.db, "INSERT INTO PortfolioThemeUpdate(id, theme_id, title, body_text, body_markdown, type, author, pinned, created_at, updated_at, soft_delete) VALUES (1,1,'n1','ALAB note','ALAB note','General','Ann',0,datetime('now'),datetime('now'),0);", nil, nil, nil)
        sqlite3_exec(manager.db, "INSERT INTO PortfolioThemeUpdate(id, theme_id, title, body_text, body_markdown, type, author, pinned, created_at, updated_at, soft_delete) VALUES (2,1,'n2','Astera Labs Inc update','Astera Labs Inc update','General','Ben',0,datetime('now'),datetime('now'),0);", nil, nil, nil)
        sqlite3_exec(manager.db, "INSERT INTO PortfolioThemeUpdate(id, theme_id, title, body_text, body_markdown, type, author, pinned, created_at, updated_at, soft_delete) VALUES (3,1,'n3','nothing','nothing','General','Cam',0,datetime('now'),datetime('now'),0);", nil, nil, nil)
        sqlite3_exec(manager.db, "INSERT INTO PortfolioThemeUpdate(id, theme_id, title, body_text, body_markdown, type, author, pinned, created_at, updated_at, soft_delete) VALUES (4,2,'n4','nothing','nothing','General','Dan',0,datetime('now'),datetime('now'),0);", nil, nil, nil)
